 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var MONKEY_PATCH_KEY_NAME="__ngContext__",HEADER_OFFSET=17,TVIEW=0,FLAGS=1,PARENT=2,NEXT=3,QUERIES=4,HOST=5,HOST_NODE=6,BINDING_INDEX=7,CLEANUP=8,CONTEXT=9,INJECTOR$1=10,RENDERER=11,SANITIZER=12,TAIL=13,CONTAINER_INDEX=14,CONTENT_QUERIES=15,DECLARATION_VIEW=16;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var renderer,rendererFactory,elementDepthCount,bindingsEnabled,previousOrParentTNode,isParent,tView,currentQueries,creationMode,viewData,_CLEAN_PROMISE=Promise.resolve(null),CIRCULAR$1="__CIRCULAR__";function getRenderer(){return renderer}function getRendererFactory(){return rendererFactory}function getCurrentSanitizer(){return viewData&&viewData[SANITIZER]}function getCurrentView(){return viewData}function restoreView(viewToRestore){contextViewData=viewToRestore}function getPreviousOrParentTNode(){return previousOrParentTNode}function _getViewData(){return viewData}var contextViewData=null;function getCleanup(view){return view[CLEANUP]||(view[CLEANUP]=[])}function getTViewCleanup(view){return view[TVIEW].cleanup||(view[TVIEW].cleanup=[])}var checkNoChangesMode=!1,firstTemplatePass=!0,bindingRootIndex=-1;function getBindingRoot(){return bindingRootIndex}function enterView(newView,hostTNode){var oldView=viewData;return tView=newView&&newView[TVIEW],creationMode=newView&&1==(1&newView[FLAGS]),firstTemplatePass=newView&&tView.firstTemplatePass,bindingRootIndex=newView&&tView.bindingStartIndex,renderer=newView&&newView[RENDERER],previousOrParentTNode=hostTNode,isParent=!0,viewData=contextViewData=newView,oldView&&(oldView[QUERIES]=currentQueries),currentQueries=newView&&newView[QUERIES],oldView}function leaveView(newView,creationOnly){creationOnly||(checkNoChangesMode||executeHooks(viewData,tView.viewHooks,tView.viewCheckHooks,creationMode),viewData[FLAGS]&=-6),viewData[FLAGS]|=16,viewData[BINDING_INDEX]=tView.bindingStartIndex,enterView(newView,null)}function refreshDescendantViews(){setHostBindings();var parentFirstTemplatePass=firstTemplatePass;tView.firstTemplatePass=firstTemplatePass=!1,checkNoChangesMode||executeInitHooks(viewData,tView,creationMode),function(lViewData){for(var current=getLViewChild(lViewData);null!==current;current=current[NEXT])if(current.length<HEADER_OFFSET&&-1===current[ACTIVE_INDEX])for(var container_1=current,i=0;i<container_1[VIEWS].length;i++){var dynamicViewData=container_1[VIEWS][i];ngDevMode&&assertDefined(dynamicViewData[TVIEW],"TView must be allocated"),renderEmbeddedTemplate(dynamicViewData,dynamicViewData[TVIEW],dynamicViewData[CONTEXT],2)}}(viewData),function(tView){if(null!=tView.contentQueries)for(var i=0;i<tView.contentQueries.length;i+=2){var directiveDefIdx=tView.contentQueries[i],directiveDef=tView.data[directiveDefIdx];directiveDef.contentQueriesRefresh(directiveDefIdx-HEADER_OFFSET,tView.contentQueries[i+1])}}(tView),checkNoChangesMode||executeHooks(viewData,tView.contentHooks,tView.contentCheckHooks,creationMode),function(components,parentFirstTemplatePass){if(null!=components)for(var i=0;i<components.length;i++)componentRefresh(components[i],parentFirstTemplatePass)}(tView.components,parentFirstTemplatePass)}function setHostBindings(){if(tView.expandoInstructions){bindingRootIndex=viewData[BINDING_INDEX]=tView.expandoStartIndex;for(var currentDirectiveIndex=-1,currentElementIndex=-1,i=0;i<tView.expandoInstructions.length;i++){var instruction=tView.expandoInstructions[i];"number"==typeof instruction?instruction<=0?(currentElementIndex=-instruction,"number"==typeof viewData[bindingRootIndex]&&(bindingRootIndex+=INJECTOR_SIZE),currentDirectiveIndex=bindingRootIndex):bindingRootIndex+=instruction:(viewData[BINDING_INDEX]=bindingRootIndex,instruction(currentDirectiveIndex-HEADER_OFFSET,currentElementIndex),currentDirectiveIndex++)}}}function executeInitAndContentHooks(){checkNoChangesMode||(executeInitHooks(viewData,tView,creationMode),executeHooks(viewData,tView.contentHooks,tView.contentCheckHooks,creationMode))}function createLViewData(renderer,tView,context,flags,sanitizer){var instance=tView.blueprint.slice();return instance[FLAGS]=25|flags,instance[PARENT]=instance[DECLARATION_VIEW]=viewData,instance[CONTEXT]=context,instance[INJECTOR$1]=viewData?viewData[INJECTOR$1]:null,instance[RENDERER]=renderer,instance[SANITIZER]=sanitizer||null,instance}function createNodeAtIndex(index,type,native,name,attrs){var adjustedIndex=index+HEADER_OFFSET;ngDevMode&&assertLessThan(adjustedIndex,viewData.length,"Slot should have been initialized with null"),viewData[adjustedIndex]=native;var tNode=tView.data[adjustedIndex];return null==tNode&&(tNode=tView.data[adjustedIndex]=createTNode(type,adjustedIndex,name,attrs,null),previousOrParentTNode&&(!isParent||null!=previousOrParentTNode.child||null===tNode.parent&&2!==previousOrParentTNode.type?isParent||(previousOrParentTNode.next=tNode):previousOrParentTNode.child=tNode)),null==tView.firstChild&&3===type&&(tView.firstChild=tNode),previousOrParentTNode=tNode,isParent=!0,tNode}function createViewNode(index,view){return null==view[TVIEW].node&&(view[TVIEW].node=createTNode(2,index,null,null,null)),isParent=!0,previousOrParentTNode=view[HOST_NODE]=view[TVIEW].node}function adjustBlueprintForNewNode(view){var tView=view[TVIEW];tView.firstTemplatePass&&(tView.expandoStartIndex++,tView.blueprint.push(null),view.push(null))}function resetComponentState(){isParent=!1,previousOrParentTNode=null,elementDepthCount=0,bindingsEnabled=!0}function renderEmbeddedTemplate(viewToRender,tView,context,rf){var oldView,_isParent=isParent,_previousOrParentTNode=previousOrParentTNode;if(64&viewToRender[FLAGS])tickRootContext(viewToRender[CONTEXT]);else try{isParent=!0,previousOrParentTNode=null,oldView=enterView(viewToRender,viewToRender[HOST_NODE]),namespaceHTML(),tView.template(rf,context),2&rf?refreshDescendantViews():viewToRender[TVIEW].firstTemplatePass=firstTemplatePass=!1}finally{leaveView(oldView,1==(1&rf)),isParent=_isParent,previousOrParentTNode=_previousOrParentTNode}}function nextContext(level){return void 0===level&&(level=1),(contextViewData=function(nestingLevel,currentView){for(;nestingLevel>0;)ngDevMode&&assertDefined(currentView[DECLARATION_VIEW],"Declaration view should be defined if nesting level is greater than 0."),currentView=currentView[DECLARATION_VIEW],nestingLevel--;return currentView}(level,contextViewData))[CONTEXT]}function renderComponentOrTemplate(hostView,componentOrContext,templateFn){var oldView=enterView(hostView,hostView[HOST_NODE]);try{rendererFactory.begin&&rendererFactory.begin(),templateFn?(namespaceHTML(),templateFn(getRenderFlags(hostView),componentOrContext),refreshDescendantViews()):(executeInitAndContentHooks(),setHostBindings(),componentRefresh(HEADER_OFFSET,!1))}finally{rendererFactory.end&&rendererFactory.end(),leaveView(oldView)}}function getRenderFlags(view){return 1&view[FLAGS]?3:2}var _currentNamespace=null;function namespaceSVG(){_currentNamespace="http://www.w3.org/2000/svg/"}function namespaceMathML(){_currentNamespace="http://www.w3.org/1998/MathML/"}function namespaceHTML(){_currentNamespace=null}function element(index,name,attrs,localRefs){elementStart(index,name,attrs,localRefs),elementEnd()}function elementStart(index,name,attrs,localRefs){ngDevMode&&assertEqual(viewData[BINDING_INDEX],tView.bindingStartIndex,"elements should be created before any bindings "),ngDevMode&&ngDevMode.rendererCreateElement++;var native=elementCreate(name);ngDevMode&&assertDataInRange(index-1);var tNode=createNodeAtIndex(index,3,native,name,attrs||null);attrs&&setUpAttributes(native,attrs),appendChild(native,tNode,viewData),createDirectivesAndLocals(localRefs),0===elementDepthCount&&attachPatchData(native,viewData),elementDepthCount++}function elementCreate(name,overriddenRenderer){var rendererToUse=overriddenRenderer||renderer;return isProceduralRenderer(rendererToUse)?rendererToUse.createElement(name,_currentNamespace):null===_currentNamespace?rendererToUse.createElement(name):rendererToUse.createElementNS(_currentNamespace,name)}function createDirectivesAndLocals(localRefs,localRefExtractor){void 0===localRefExtractor&&(localRefExtractor=getNativeByTNode),bindingsEnabled&&(firstTemplatePass?(ngDevMode&&ngDevMode.firstTemplatePass++,function(tNode,tView,localRefs){var exportsMap=localRefs?{"":-1}:null,matches=tView.currentMatches=findDirectiveMatches(tNode);generateExpandoBlock(tNode,matches);var totalHostVars=0;if(matches)for(var i=0;i<matches.length;i+=2){var def=matches[i],valueIndex=i+1;resolveDirective(def,valueIndex,matches),totalHostVars+=def.hostVars,saveNameToExportMap(matches[valueIndex],def,exportsMap)}exportsMap&&function(tNode,localRefs,exportsMap){if(localRefs)for(var localNames=tNode.localNames=[],i=0;i<localRefs.length;i+=2){var index=exportsMap[localRefs[i+1]];if(null==index)throw new Error("Export of name '"+localRefs[i+1]+"' not found!");localNames.push(localRefs[i],index)}}(tNode,localRefs,exportsMap);prefillHostVars(totalHostVars)}(previousOrParentTNode,tView,localRefs||null)):function(){ngDevMode&&assertEqual(firstTemplatePass,!1,"Directives should only be instantiated directly after first template pass");var count=4095&previousOrParentTNode.flags;isContentQueryHost(previousOrParentTNode)&&currentQueries&&(currentQueries=currentQueries.clone());if(count>0)for(var start=previousOrParentTNode.flags>>15,end=start+count,i=start;i<end;i++){var def=tView.data[i];def.template&&addComponentLogic(def),directiveCreate(i,def.factory(),def)}}(),function(localRefExtractor){var localNames=previousOrParentTNode.localNames,tNode=previousOrParentTNode;if(localNames)for(var localIndex=previousOrParentTNode.index+1,i=0;i<localNames.length;i+=2){var index=localNames[i+1],value=-1===index?localRefExtractor(tNode,viewData):viewData[index];viewData[localIndex++]=value}}(localRefExtractor))}function generateExpandoBlock(tNode,matches){var directiveCount=matches?matches.length/2:0,elementIndex=-(tNode.index-HEADER_OFFSET);directiveCount>0&&(tView.expandoInstructions||(tView.expandoInstructions=[])).push(elementIndex,directiveCount)}function prefillHostVars(totalHostVars){for(var i=0;i<totalHostVars;i++)viewData.push(NO_CHANGE),tView.blueprint.push(NO_CHANGE),tView.data.push(null)}function findDirectiveMatches(tNode){var registry=tView.directiveRegistry,matches=null;if(registry)for(var i=0;i<registry.length;i++){var def=registry[i];isNodeMatchingSelectorList(tNode,def.selectors)&&(matches||(matches=[]),def.diPublic&&def.diPublic(def),def.template?(4096&tNode.flags&&throwMultipleComponentError(tNode),addComponentLogic(def),matches.unshift(def,null)):matches.push(def,null))}return matches}function resolveDirective(def,valueIndex,matches){if(null===matches[valueIndex]){matches[valueIndex]=CIRCULAR$1;var instance=def.factory();return directiveCreate(matches[valueIndex]=viewData.length,instance,def)}return matches[valueIndex]===CIRCULAR$1&&function(token){throw new Error("Cannot instantiate cyclic dependency! "+token)}(def.type),null}function queueComponentIndexForCheck(){firstTemplatePass&&(tView.components||(tView.components=[])).push(previousOrParentTNode.index)}function saveNameToExportMap(index,def,exportsMap){exportsMap&&(def.exportAs&&(exportsMap[def.exportAs]=index),def.template&&(exportsMap[""]=index))}function getOrCreateTView(templateFn,consts,vars,directives,pipes,viewQuery){return templateFn.ngPrivateData||(templateFn.ngPrivateData=createTView(-1,templateFn,consts,vars,directives,pipes,viewQuery))}function createTView(viewIndex,templateFn,consts,vars,directives,pipes,viewQuery){ngDevMode&&ngDevMode.tView++;var bindingStartIndex=HEADER_OFFSET+consts,initialViewLength=bindingStartIndex+vars,blueprint=function(bindingStartIndex,initialViewLength){var blueprint=new Array(initialViewLength).fill(null,0,bindingStartIndex).fill(NO_CHANGE,bindingStartIndex);return blueprint[CONTAINER_INDEX]=-1,blueprint[BINDING_INDEX]=bindingStartIndex,blueprint}(bindingStartIndex,initialViewLength);return blueprint[TVIEW]={id:viewIndex,blueprint:blueprint,template:templateFn,viewQuery:viewQuery,node:null,data:blueprint.slice(),childIndex:-1,bindingStartIndex:bindingStartIndex,expandoStartIndex:initialViewLength,expandoInstructions:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,cleanup:null,contentQueries:null,components:null,directiveRegistry:"function"==typeof directives?directives():directives,pipeRegistry:"function"==typeof pipes?pipes():pipes,currentMatches:null,firstChild:null}}function setUpAttributes(native,attrs){for(var isProc=isProceduralRenderer(renderer),i=0;i<attrs.length;){var attrName=attrs[i];if(1===attrName)break;if(attrName===NG_PROJECT_AS_ATTR_NAME)i+=2;else if(ngDevMode&&ngDevMode.rendererSetAttribute++,0===attrName){var namespaceURI=attrs[i+1],attrName_1=attrs[i+2],attrVal=attrs[i+3];isProc?renderer.setAttribute(native,attrName_1,attrVal,namespaceURI):native.setAttributeNS(namespaceURI,attrName_1,attrVal),i+=4}else{attrVal=attrs[i+1];isProc?renderer.setAttribute(native,attrName,attrVal):native.setAttribute(attrName,attrVal),i+=2}}}function createError(text,token){return new Error("Renderer: "+text+" ["+stringify$1(token)+"]")}function locateHostElement(factory,elementOrSelector){ngDevMode&&assertDataInRange(-1),rendererFactory=factory;var defaultRenderer=factory.createRenderer(null,null),rNode="string"==typeof elementOrSelector?isProceduralRenderer(defaultRenderer)?defaultRenderer.selectRootElement(elementOrSelector):defaultRenderer.querySelector(elementOrSelector):elementOrSelector;if(ngDevMode&&!rNode)throw createError("string"==typeof elementOrSelector?"Host node with selector not found:":"Host node is required:",elementOrSelector);return rNode}function listener(eventName,listenerFn,useCapture){void 0===useCapture&&(useCapture=!1);var tNode=previousOrParentTNode;if(ngDevMode&&assertNodeOfPossibleTypes(tNode,3,0,4),3===tNode.type){var native=getNativeByTNode(previousOrParentTNode,viewData);if(ngDevMode&&ngDevMode.rendererAddEventListener++,isProceduralRenderer(renderer)){var cleanupFn=renderer.listen(native,eventName,listenerFn);storeCleanupFn(viewData,cleanupFn)}else{var wrappedListener=function(listenerFn){return function(e){!1===listenerFn(e)&&(e.preventDefault(),e.returnValue=!1)}}(listenerFn);native.addEventListener(eventName,wrappedListener,useCapture);var cleanupInstances=getCleanup(viewData);cleanupInstances.push(wrappedListener),firstTemplatePass&&getTViewCleanup(viewData).push(eventName,tNode.index,cleanupInstances.length-1,useCapture)}}void 0===tNode.outputs&&(tNode.outputs=generatePropertyAliases(tNode.flags,1));var outputData,outputs=tNode.outputs;outputs&&(outputData=outputs[eventName])&&function(outputs,listener){for(var i=0;i<outputs.length;i+=2){ngDevMode&&assertDataInRange(outputs[i],viewData);var subscription=viewData[outputs[i]][outputs[i+1]].subscribe(listener);storeCleanupWithContext(viewData,subscription,subscription.unsubscribe)}}(outputData,listenerFn)}function storeCleanupWithContext(view,context,cleanupFn){view||(view=viewData),getCleanup(view).push(context),view[TVIEW].firstTemplatePass&&getTViewCleanup(view).push(cleanupFn,view[CLEANUP].length-1)}function storeCleanupFn(view,cleanupFn){getCleanup(view).push(cleanupFn),view[TVIEW].firstTemplatePass&&getTViewCleanup(view).push(view[CLEANUP].length-1,null)}function elementEnd(){isParent?isParent=!1:(ngDevMode&&assertHasParent(),previousOrParentTNode=previousOrParentTNode.parent),ngDevMode&&assertNodeType(previousOrParentTNode,3),currentQueries&&(currentQueries=currentQueries.addNode(previousOrParentTNode)),queueLifecycleHooks(previousOrParentTNode.flags,tView),elementDepthCount--}function elementAttribute(index,name,value,sanitizer){if(value!==NO_CHANGE){var element_1=getNativeByIndex(index,viewData);if(null==value)ngDevMode&&ngDevMode.rendererRemoveAttribute++,isProceduralRenderer(renderer)?renderer.removeAttribute(element_1,name):element_1.removeAttribute(name);else{ngDevMode&&ngDevMode.rendererSetAttribute++;var strValue=null==sanitizer?stringify$1(value):sanitizer(value);isProceduralRenderer(renderer)?renderer.setAttribute(element_1,name,strValue):element_1.setAttribute(name,strValue)}}}function elementProperty(index,propName,value,sanitizer){if(value!==NO_CHANGE){var element=getNativeByIndex(index,viewData),tNode=getTNode(index,viewData);tNode&&void 0===tNode.inputs&&(tNode.inputs=generatePropertyAliases(tNode.flags,0));var dataValue,view,inputData=tNode&&tNode.inputs;inputData&&(dataValue=inputData[propName])?(!function(inputs,value){for(var i=0;i<inputs.length;i+=2)ngDevMode&&assertDataInRange(inputs[i],viewData),viewData[inputs[i]][inputs[i+1]]=value}(dataValue,value),isComponent(tNode)&&(2&(view=getComponentViewByIndex(index+HEADER_OFFSET,viewData))[FLAGS]||(view[FLAGS]|=4))):3===tNode.type&&(value=null!=sanitizer?sanitizer(value):value,ngDevMode&&ngDevMode.rendererSetProperty++,isProceduralRenderer(renderer)?renderer.setProperty(element,propName,value):element.setProperty?element.setProperty(propName,value):element[propName]=value)}}function enableBindings(){bindingsEnabled=!0}function disableBindings(){bindingsEnabled=!1}function createTNode(type,adjustedIndex,tagName,attrs,tViews){ngDevMode&&ngDevMode.tNode++;var parent=isParent?previousOrParentTNode:previousOrParentTNode&&previousOrParentTNode.parent,tParent=parent&&viewData&&parent!==viewData[HOST_NODE]?parent:null;return{type:type,index:adjustedIndex,injectorIndex:tParent?tParent.injectorIndex:-1,flags:0,tagName:tagName,attrs:attrs,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:tViews,next:null,child:null,parent:tParent,detached:null,stylingTemplate:null,projection:null}}function generatePropertyAliases(tNodeFlags,direction){var count=4095&tNodeFlags,propStore=null;if(count>0)for(var start=tNodeFlags>>15,end=start+count,isInput=0===direction,defs=tView.data,i=start;i<end;i++){var directiveDef=defs[i],propertyAliasMap=isInput?directiveDef.inputs:directiveDef.outputs;for(var publicName in propertyAliasMap)if(propertyAliasMap.hasOwnProperty(publicName)){propStore=propStore||{};var internalName=propertyAliasMap[publicName];propStore.hasOwnProperty(publicName)?propStore[publicName].push(i,internalName):propStore[publicName]=[i,internalName]}}return propStore}function elementClassProp(index,stylingIndex,value){!function(context,index,addOrRemove){updateStyleProp(context,index+context[4],addOrRemove)}(getStylingContext(index,viewData),stylingIndex,!!value)}function elementStyling(classDeclarations,styleDeclarations,styleSanitizer){var tNode=previousOrParentTNode;tNode.stylingTemplate||(tNode.stylingTemplate=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(initialClassDeclarations,initialStyleDeclarations,styleSanitizer){var initialStylingValues=[null],context=createEmptyStylingContext(null,styleSanitizer,initialStylingValues),stylesLookup={},classesLookup={},totalStyleDeclarations=0;if(initialStyleDeclarations)for(var hasPassedDeclarations=!1,i=0;i<initialStyleDeclarations.length;i++)if(1===(v=initialStyleDeclarations[i]))hasPassedDeclarations=!0;else{var prop=v;if(hasPassedDeclarations){var value=initialStyleDeclarations[++i];initialStylingValues.push(value),stylesLookup[prop]=initialStylingValues.length-1}else totalStyleDeclarations++,stylesLookup[prop]=0}if(context[4]=totalStyleDeclarations,initialClassDeclarations)for(hasPassedDeclarations=!1,i=0;i<initialClassDeclarations.length;i++){var v;if(1===(v=initialClassDeclarations[i]))hasPassedDeclarations=!0;else{var className=v;hasPassedDeclarations?(value=initialClassDeclarations[++i],initialStylingValues.push(value),classesLookup[className]=initialStylingValues.length-1):classesLookup[className]=0}}var styleProps=Object.keys(stylesLookup),classNames=Object.keys(classesLookup),classNamesIndexStart=styleProps.length,totalProps=styleProps.length+classNames.length,maxLength=3*totalProps*2+8;for(i=8;i<maxLength;i++)context.push(null);var multiStart=3*totalProps+8;for(i=0;i<totalProps;i++){var isClassBased_1=i>=classNamesIndexStart,indexForInitial=(prop=isClassBased_1?classNames[i-classNamesIndexStart]:styleProps[i],isClassBased_1?classesLookup[prop]:stylesLookup[prop]),initialValue=initialStylingValues[indexForInitial],indexForMulti=3*i+multiStart,indexForSingle=3*i+8,initialFlag=prepareInitialFlag(prop,isClassBased_1,styleSanitizer||null);setFlag(context,indexForSingle,pointers(initialFlag,indexForInitial,indexForMulti)),setProp(context,indexForSingle,prop),setValue(context,indexForSingle,null),setFlag(context,indexForMulti,pointers(initialFlag|(null!==initialValue?1:0),indexForInitial,indexForSingle)),setProp(context,indexForMulti,prop),setValue(context,indexForMulti,null)}return setFlag(context,3,pointers(0,0,multiStart)),setContextDirty(context,initialStylingValues.length>1),context}(classDeclarations,styleDeclarations,styleSanitizer)),(styleDeclarations&&styleDeclarations.length||classDeclarations&&classDeclarations.length)&&elementStylingApply(tNode.index-HEADER_OFFSET)}function elementStylingApply(index){renderStyling(getStylingContext(index,viewData),renderer)}function elementStyleProp(index,styleIndex,value,suffix){var valueToAdd=null;value&&(valueToAdd=suffix?stringify$1(value)+suffix:value),updateStyleProp(getStylingContext(index,viewData),styleIndex,valueToAdd)}function elementStylingMap(index,classes,styles){!function(context,classes,styles){styles=styles||null;var ignoreAllClassUpdates=classes===context[6],ignoreAllStyleUpdates=styles===context[7];if(!ignoreAllClassUpdates||!ignoreAllStyleUpdates){var classNames=EMPTY_ARR,applyAllClasses=!1;ignoreAllClassUpdates||(context[6]=classes,"string"==typeof classes?(classNames=classes.split(/\s+/),applyAllClasses=!0):classNames=classes?Object.keys(classes):EMPTY_ARR),classes=classes||EMPTY_OBJ,ignoreAllStyleUpdates||(context[7]=styles);var styleProps=styles?Object.keys(styles):EMPTY_ARR;styles=styles||EMPTY_OBJ;for(var classesStartIndex=styleProps.length,dirty=!1,ctxIndex=getMultiStartIndex(context),propIndex=0,propLimit=styleProps.length+classNames.length;ctxIndex<context.length&&propIndex<propLimit;){var isClassBased_2=propIndex>=classesStartIndex;if(!isClassBased_2&&!ignoreAllStyleUpdates||isClassBased_2&&!ignoreAllClassUpdates){var adjustedPropIndex=isClassBased_2?propIndex-classesStartIndex:propIndex,newProp=isClassBased_2?classNames[adjustedPropIndex]:styleProps[adjustedPropIndex],newValue=isClassBased_2?!!applyAllClasses||classes[newProp]:styles[newProp];if((prop=getProp(context,ctxIndex))===newProp){var value=getValue(context,ctxIndex);hasValueChanged(flag=getPointers(context,ctxIndex),value,newValue)&&(setValue(context,ctxIndex,newValue),hasValueChanged(flag,initialValue=getInitialValue(context,flag),newValue)&&(setDirty(context,ctxIndex,!0),dirty=!0))}else{var indexOfEntry=findEntryPositionByProp(context,newProp,ctxIndex);if(indexOfEntry>0){var valueToCompare=getValue(context,indexOfEntry),flagToCompare=getPointers(context,indexOfEntry);if(swapMultiContextEntries(context,ctxIndex,indexOfEntry),hasValueChanged(flagToCompare,valueToCompare,newValue)){var initialValue=getInitialValue(context,flagToCompare);setValue(context,ctxIndex,newValue),hasValueChanged(flagToCompare,initialValue,newValue)&&(setDirty(context,ctxIndex,!0),dirty=!0)}}else insertNewMultiProperty(context,ctxIndex,isClassBased_2,newProp,prepareInitialFlag(newProp,isClassBased_2,getStyleSanitizer(context)),newValue),dirty=!0}}ctxIndex+=3,propIndex++}for(;ctxIndex<context.length;){var isClassBased_3=2==(2&(flag=getPointers(context,ctxIndex)));(!isClassBased_3&&!ignoreAllStyleUpdates||isClassBased_3&&!ignoreAllClassUpdates)&&valueExists(value=getValue(context,ctxIndex),isClassBased_3)&&(setDirty(context,ctxIndex,!0),setValue(context,ctxIndex,null),dirty=!0),ctxIndex+=3}for(var sanitizer=getStyleSanitizer(context);propIndex<propLimit;){var isClassBased_4=propIndex>=classesStartIndex;if(!isClassBased_4&&!ignoreAllStyleUpdates||isClassBased_4&&!ignoreAllClassUpdates){adjustedPropIndex=isClassBased_4?propIndex-classesStartIndex:propIndex;var prop=isClassBased_4?classNames[adjustedPropIndex]:styleProps[adjustedPropIndex],flag=(value=isClassBased_4?!!applyAllClasses||classes[prop]:styles[prop],1|prepareInitialFlag(prop,isClassBased_4,sanitizer));context.push(flag,prop,value),dirty=!0}propIndex++}dirty&&setContextDirty(context,!0)}}(getStylingContext(index,viewData),classes,styles)}function text(index,value){ngDevMode&&assertEqual(viewData[BINDING_INDEX],tView.bindingStartIndex,"text nodes should be created before any bindings"),ngDevMode&&ngDevMode.rendererCreateTextNode++;var textNative=createTextNode(value,renderer),tNode=createNodeAtIndex(index,3,textNative,null,null);isParent=!1,appendChild(textNative,tNode,viewData)}function textBinding(index,value){if(value!==NO_CHANGE){ngDevMode&&assertDataInRange(index+HEADER_OFFSET);var element_2=getNativeByIndex(index,viewData);ngDevMode&&assertDefined(element_2,"native element should exist"),ngDevMode&&ngDevMode.rendererSetText++,isProceduralRenderer(renderer)?renderer.setValue(element_2,stringify$1(value)):element_2.textContent=stringify$1(value)}}function directiveCreate(directiveDefIdx,directive,directiveDef){var instance=baseDirectiveCreate(directiveDefIdx,directive,directiveDef,getNativeByTNode(previousOrParentTNode,viewData));directiveDef.template&&(getComponentViewByIndex(previousOrParentTNode.index,viewData)[CONTEXT]=directive);return firstTemplatePass&&queueInitHooks(directiveDefIdx,directiveDef.onInit,directiveDef.doCheck,tView),ngDevMode&&assertDefined(previousOrParentTNode,"previousOrParentTNode"),previousOrParentTNode&&previousOrParentTNode.attrs&&function(directiveIndex,instance,inputs,tNode){var initialInputData=tNode.initialInputs;(void 0===initialInputData||directiveIndex>=initialInputData.length)&&(initialInputData=function(directiveIndex,inputs,tNode){var initialInputData=tNode.initialInputs||(tNode.initialInputs=[]);initialInputData[directiveIndex]=null;var attrs=tNode.attrs,i=0;for(;i<attrs.length;){var attrName=attrs[i];if(1===attrName)break;if(0!==attrName){var minifiedInputName=inputs[attrName],attrValue=attrs[i+1];if(void 0!==minifiedInputName){var inputsToStore=initialInputData[directiveIndex]||(initialInputData[directiveIndex]=[]);inputsToStore.push(minifiedInputName,attrValue)}i+=2}else i+=4}return initialInputData}(directiveIndex,inputs,tNode));var initialInputs=initialInputData[directiveIndex];if(initialInputs)for(var i=0;i<initialInputs.length;i+=2)instance[initialInputs[i]]=initialInputs[i+1]}(directiveDefIdx,instance,directiveDef.inputs,previousOrParentTNode),directiveDef.contentQueries&&directiveDef.contentQueries(),instance}function addComponentLogic(def){var native=getNativeByTNode(previousOrParentTNode,viewData),tView=getOrCreateTView(def.template,def.consts,def.vars,def.directiveDefs,def.pipeDefs,def.viewQuery),componentView=addToViewTree(viewData,previousOrParentTNode.index,createLViewData(rendererFactory.createRenderer(native,def),tView,null,def.onPush?4:2,getCurrentSanitizer()));componentView[HOST_NODE]=previousOrParentTNode,componentView[HOST]=viewData[previousOrParentTNode.index],viewData[previousOrParentTNode.index]=componentView,firstTemplatePass&&(queueComponentIndexForCheck(),previousOrParentTNode.flags=viewData.length<<15|4096)}function baseDirectiveCreate(index,directive,directiveDef,native){if(ngDevMode&&assertEqual(viewData[BINDING_INDEX],tView.bindingStartIndex,"directives should be created before any bindings"),ngDevMode&&assertPreviousIsParent(),attachPatchData(directive,viewData),native&&attachPatchData(native,viewData),viewData[index]=directive,firstTemplatePass){var flags=previousOrParentTNode.flags;0===flags?previousOrParentTNode.flags=index<<15|4096&flags|1:(ngDevMode&&assertNotEqual(4095&flags,4095,"Reached the max number of directives"),previousOrParentTNode.flags++),tView.data.push(directiveDef),tView.blueprint.push(null),directiveDef.hostBindings&&(def=directiveDef,ngDevMode&&assertEqual(firstTemplatePass,!0,"Should only be called in first template pass."),tView.expandoInstructions.push(def.hostBindings,def.hostVars))}else{var diPublic=directiveDef.diPublic;diPublic&&diPublic(directiveDef)}var def;return null!=directiveDef.attributes&&3==previousOrParentTNode.type&&setUpAttributes(native,directiveDef.attributes),directive}function createLContainer(hostNative,hostTNode,currentView,native,isForViewContainerRef){return[isForViewContainerRef?-1:0,[],currentView,null,null,hostNative,native,getRenderParent(hostTNode,currentView)]}function template(index,templateFn,consts,vars,tagName,attrs,localRefs,localRefExtractor){var tNode=containerInternal(index,tagName||null,attrs||null);firstTemplatePass&&(tNode.tViews=createTView(-1,templateFn,consts,vars,tView.directiveRegistry,tView.pipeRegistry,null)),createDirectivesAndLocals(localRefs,localRefExtractor),currentQueries&&(currentQueries=currentQueries.addNode(previousOrParentTNode)),queueLifecycleHooks(tNode.flags,tView),isParent=!1}function container(index){var tNode=containerInternal(index,null,null);firstTemplatePass&&(tNode.tViews=[]),isParent=!1}function containerInternal(index,tagName,attrs){ngDevMode&&assertEqual(viewData[BINDING_INDEX],tView.bindingStartIndex,"container nodes should be created before any bindings");var adjustedIndex=index+HEADER_OFFSET,comment=renderer.createComment(ngDevMode?"container":"");ngDevMode&&ngDevMode.rendererCreateComment++;var tNode=createNodeAtIndex(index,0,comment,tagName,attrs),lContainer=viewData[adjustedIndex]=createLContainer(viewData[adjustedIndex],tNode,viewData,comment);return appendChild(comment,tNode,viewData),addToViewTree(viewData,index+HEADER_OFFSET,lContainer),currentQueries&&(lContainer[QUERIES]=currentQueries.container()),ngDevMode&&assertNodeType(previousOrParentTNode,0),tNode}function containerRefreshStart(index){previousOrParentTNode=loadInternal(index,tView.data),ngDevMode&&assertNodeType(previousOrParentTNode,0),isParent=!0,viewData[index+HEADER_OFFSET][ACTIVE_INDEX]=0,checkNoChangesMode||executeInitHooks(viewData,tView,creationMode)}function containerRefreshEnd(){isParent?isParent=!1:(ngDevMode&&assertNodeType(previousOrParentTNode,2),ngDevMode&&assertHasParent(),previousOrParentTNode=previousOrParentTNode.parent),ngDevMode&&assertNodeType(previousOrParentTNode,0);for(var lContainer=viewData[previousOrParentTNode.index],nextIndex=lContainer[ACTIVE_INDEX];nextIndex<lContainer[VIEWS].length;)removeView(lContainer,previousOrParentTNode,nextIndex)}function embeddedViewStart(viewBlockId,consts,vars){var containerTNode=2===previousOrParentTNode.type?previousOrParentTNode.parent:previousOrParentTNode,lContainer=viewData[containerTNode.index],currentView=viewData;ngDevMode&&assertNodeType(containerTNode,0);var viewToRender=function(lContainer,tContainerNode,startIdx,viewBlockId){for(var views=lContainer[VIEWS],i=startIdx;i<views.length;i++){var viewAtPositionId=views[i][TVIEW].id;if(viewAtPositionId===viewBlockId)return views[i];if(!(viewAtPositionId<viewBlockId))break;removeView(lContainer,tContainerNode,i)}return null}(lContainer,containerTNode,lContainer[ACTIVE_INDEX],viewBlockId);return viewToRender?(isParent=!0,enterView(viewToRender,viewToRender[TVIEW].node)):(viewToRender=createLViewData(renderer,function(viewIndex,consts,vars,parent){ngDevMode&&assertNodeType(parent,0);var containerTViews=parent.tViews;ngDevMode&&assertDefined(containerTViews,"TView expected"),ngDevMode&&assertEqual(Array.isArray(containerTViews),!0,"TViews should be in an array"),(viewIndex>=containerTViews.length||null==containerTViews[viewIndex])&&(containerTViews[viewIndex]=createTView(viewIndex,null,consts,vars,tView.directiveRegistry,tView.pipeRegistry,null));return containerTViews[viewIndex]}(viewBlockId,consts,vars,containerTNode),null,2,getCurrentSanitizer()),lContainer[QUERIES]&&(viewToRender[QUERIES]=lContainer[QUERIES].createView()),createViewNode(viewBlockId,viewToRender),enterView(viewToRender,viewToRender[TVIEW].node)),lContainer&&(creationMode&&insertView(viewToRender,lContainer,currentView,lContainer[ACTIVE_INDEX],-1),lContainer[ACTIVE_INDEX]++),getRenderFlags(viewToRender)}function embeddedViewEnd(){var viewHost=viewData[HOST_NODE];refreshDescendantViews(),leaveView(viewData[PARENT]),previousOrParentTNode=viewHost,isParent=!1}function componentRefresh(adjustedElementIndex,parentFirstTemplatePass){ngDevMode&&assertDataInRange(adjustedElementIndex);var hostView=getComponentViewByIndex(adjustedElementIndex,viewData);ngDevMode&&assertNodeType(tView.data[adjustedElementIndex],3),viewAttached(hostView)&&6&hostView[FLAGS]&&(parentFirstTemplatePass&&function(componentView){for(var componentTView=componentView[TVIEW],i=componentView.length;i<componentTView.blueprint.length;i++)componentView[i]=componentTView.blueprint[i]}(hostView),detectChangesInternal(hostView,hostView[CONTEXT]))}function viewAttached(view){return 8==(8&view[FLAGS])}function projectionDef(selectors,textSelectors){var componentNode=findComponentView(viewData)[HOST_NODE];if(!componentNode.projection)for(var noOfNodeBuckets=selectors?selectors.length+1:1,pData=componentNode.projection=new Array(noOfNodeBuckets).fill(null),tails=pData.slice(),componentChild=componentNode.child;null!==componentChild;){var bucketIndex=selectors?matchingSelectorIndex(componentChild,selectors,textSelectors):0,nextNode=componentChild.next;tails[bucketIndex]?tails[bucketIndex].next=componentChild:(pData[bucketIndex]=componentChild,componentChild.next=null),tails[bucketIndex]=componentChild,componentChild=nextNode}}var projectionNodeStack=[];function projection(nodeIndex,selectorIndex,attrs){void 0===selectorIndex&&(selectorIndex=0);var tProjectionNode=createNodeAtIndex(nodeIndex,1,null,null,attrs||null);null===tProjectionNode.projection&&(tProjectionNode.projection=selectorIndex),isParent=!1;for(var componentView=findComponentView(viewData),nodeToProject=componentView[HOST_NODE].projection[selectorIndex],projectedView=componentView[PARENT],projectionNodeIndex=-1;nodeToProject;){if(1===nodeToProject.type){var currentComponentView=findComponentView(projectedView),firstProjectedNode=currentComponentView[HOST_NODE].projection[nodeToProject.projection];if(firstProjectedNode){projectionNodeStack[++projectionNodeIndex]=nodeToProject,projectionNodeStack[++projectionNodeIndex]=projectedView,nodeToProject=firstProjectedNode,projectedView=currentComponentView[PARENT];continue}}else nodeToProject.flags|=8192,appendProjectedNode(nodeToProject,tProjectionNode,viewData,projectedView);null===nodeToProject.next&&projectedView!==componentView[PARENT]&&(projectedView=projectionNodeStack[projectionNodeIndex--],nodeToProject=projectionNodeStack[projectionNodeIndex--]),nodeToProject=nodeToProject.next}}function addToViewTree(currentView,adjustedHostIndex,state){return currentView[TAIL]?currentView[TAIL][NEXT]=state:firstTemplatePass&&(tView.childIndex=adjustedHostIndex),currentView[TAIL]=state,state}function markViewDirty(view){for(var currentView=view;currentView&&!(64&currentView[FLAGS]);)currentView[FLAGS]|=4,currentView=currentView[PARENT];currentView[FLAGS]|=4,ngDevMode&&assertDefined(currentView[CONTEXT],"rootContext should be defined");var rootContext=currentView[CONTEXT],nothingScheduled=0===rootContext.flags;rootContext.flags|=1,nothingScheduled&&scheduleTick(rootContext)}function scheduleTick(rootContext){if(rootContext.clean==_CLEAN_PROMISE){var res_1=void 0;rootContext.clean=new Promise(function(r){return res_1=r}),rootContext.scheduler(function(){if(1&rootContext.flags&&(rootContext.flags&=-2,tickRootContext(rootContext)),2&rootContext.flags){rootContext.flags&=-3;var playerHandler=rootContext.playerHandler;playerHandler&&playerHandler.flushPlayers()}rootContext.clean=_CLEAN_PROMISE,res_1(null)})}}function tickRootContext(rootContext){for(var i=0;i<rootContext.components.length;i++){var rootComponent=rootContext.components[i];renderComponentOrTemplate(readPatchedLViewData(rootComponent),rootComponent)}}function detectChanges(component){detectChangesInternal(getComponentViewByInstance(component),component)}function detectChangesInRootView(lViewData){tickRootContext(lViewData[CONTEXT])}function detectChangesInternal(hostView,component){var hostTView=hostView[TVIEW],oldView=enterView(hostView,hostView[HOST_NODE]),templateFn=hostTView.template,viewQuery=hostTView.viewQuery;try{namespaceHTML(),function(viewQuery,flags,component){viewQuery&&1&flags&&viewQuery(1,component)}(viewQuery,hostView[FLAGS],component),templateFn(getRenderFlags(hostView),component),refreshDescendantViews(),function(viewQuery,component){viewQuery&&viewQuery(2,component)}(viewQuery,component)}finally{leaveView(oldView)}}var NO_CHANGE={};function bind(value){return bindingUpdated(viewData[BINDING_INDEX]++,value)?value:NO_CHANGE}function interpolationV(values){ngDevMode&&assertLessThan(2,values.length,"should have at least 3 values"),ngDevMode&&assertEqual(values.length%2,1,"should have an odd number of values");for(var different=!1,i=1;i<values.length;i+=2)bindingUpdated(viewData[BINDING_INDEX]++,values[i])&&(different=!0);if(!different)return NO_CHANGE;var content=values[0];for(i=1;i<values.length;i+=2)content+=stringify$1(values[i])+values[i+1];return content}function interpolation1(prefix,v0,suffix){return bindingUpdated(viewData[BINDING_INDEX]++,v0)?prefix+stringify$1(v0)+suffix:NO_CHANGE}function interpolation2(prefix,v0,i0,v1,suffix){var different=bindingUpdated2(viewData[BINDING_INDEX],v0,v1);return viewData[BINDING_INDEX]+=2,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+suffix:NO_CHANGE}function interpolation3(prefix,v0,i0,v1,i1,v2,suffix){var different=bindingUpdated3(viewData[BINDING_INDEX],v0,v1,v2);return viewData[BINDING_INDEX]+=3,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+suffix:NO_CHANGE}function interpolation4(prefix,v0,i0,v1,i1,v2,i2,v3,suffix){var different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return viewData[BINDING_INDEX]+=4,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+suffix:NO_CHANGE}function interpolation5(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,suffix){var different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated(viewData[BINDING_INDEX]+4,v4)||different,viewData[BINDING_INDEX]+=5,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+suffix:NO_CHANGE}function interpolation6(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,suffix){var different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated2(viewData[BINDING_INDEX]+4,v4,v5)||different,viewData[BINDING_INDEX]+=6,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+suffix:NO_CHANGE}function interpolation7(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,suffix){var different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated3(viewData[BINDING_INDEX]+4,v4,v5,v6)||different,viewData[BINDING_INDEX]+=7,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+suffix:NO_CHANGE}function interpolation8(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,i6,v7,suffix){var different=bindingUpdated4(viewData[BINDING_INDEX],v0,v1,v2,v3);return different=bindingUpdated4(viewData[BINDING_INDEX]+4,v4,v5,v6,v7)||different,viewData[BINDING_INDEX]+=8,different?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+i6+stringify$1(v7)+suffix:NO_CHANGE}function store(index,value){var adjustedIndex=index+HEADER_OFFSET;adjustedIndex>=tView.data.length&&(tView.data[adjustedIndex]=null),viewData[adjustedIndex]=value}function reference(index){return loadInternal(index,contextViewData)}function loadQueryList(queryListIdx){return ngDevMode&&assertDefined(viewData[CONTENT_QUERIES],"Content QueryList array should be defined if reading a query."),ngDevMode&&assertDataInRange(queryListIdx,viewData[CONTENT_QUERIES]),viewData[CONTENT_QUERIES][queryListIdx]}function load(index){return loadInternal(index,viewData)}function getBinding(bindingIndex){return ngDevMode&&assertDataInRange(viewData[bindingIndex]),ngDevMode&&assertNotEqual(viewData[bindingIndex],NO_CHANGE,"Stored value should never be NO_CHANGE."),viewData[bindingIndex]}function bindingUpdated(bindingIndex,value){if(ngDevMode&&assertNotEqual(value,NO_CHANGE,"Incoming value should never be NO_CHANGE."),ngDevMode&&assertLessThan(bindingIndex,viewData.length,"Slot should have been initialized to NO_CHANGE"),viewData[bindingIndex]===NO_CHANGE)viewData[bindingIndex]=value;else{if(!
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function createRootComponentView(rNode,def,rootView,renderer,sanitizer){resetComponentState();var tView=rootView[TVIEW],componentView=createLViewData(renderer,getOrCreateTView(def.template,def.consts,def.vars,def.directiveDefs,def.pipeDefs,def.viewQuery),null,def.onPush?4:2,sanitizer),tNode=createNodeAtIndex(0,3,rNode,null,null);return tView.firstTemplatePass&&(tView.expandoInstructions=ROOT_EXPANDO_INSTRUCTIONS.slice(),def.diPublic&&def.diPublic(def),tNode.flags=rootView.length<<15|4096),componentView[HOST]=rootView[HEADER_OFFSET],componentView[HOST_NODE]=tNode,rootView[HEADER_OFFSET]=componentView}function createRootComponent(hostRNode,componentView,componentDef,rootView,rootContext,hostFeatures){var component=baseDirectiveCreate(rootView.length,componentDef.factory(),componentDef,hostRNode);return rootContext.components.push(component),componentView[CONTEXT]=component,hostFeatures&&hostFeatures.forEach(function(feature){return feature(component,componentDef)}),rootView[TVIEW].firstTemplatePass&&prefillHostVars(componentDef.hostVars),setHostBindings(),component}function createRootContext(scheduler,playerHandler){return{components:[],scheduler:scheduler,clean:CLEAN_PROMISE,playerHandler:playerHandler||null,flags:0}}function LifecycleHooksFeature(component,def){var rootTView=readPatchedLViewData(component)[TVIEW],dirIndex=rootTView.data.length-1;queueInitHooks(dirIndex,def.onInit,def.doCheck,rootTView),queueLifecycleHooks(dirIndex<<15|1,rootTView)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var BLOOM_MASK=255,nextNgElementId=0;function getOrCreateNodeInjectorForNode(tNode,hostView){var existingInjectorIndex=getInjectorIndex(tNode,hostView);if(-1!==existingInjectorIndex)return existingInjectorIndex;var tView=hostView[TVIEW];tView.firstTemplatePass&&(tNode.injectorIndex=hostView.length,setUpBloom(tView.data,tNode),setUpBloom(hostView,null),setUpBloom(tView.blueprint,null));var parentLoc=getParentInjectorLocation(tNode,hostView),parentIndex=32767&parentLoc,parentView=getParentInjectorView(parentLoc,hostView),parentData=parentView[TVIEW].data,injectorIndex=tNode.injectorIndex;if(-1!==parentLoc)for(var i=0;i<PARENT_INJECTOR;i++){var bloomIndex=parentIndex+i;hostView[injectorIndex+i]=parentView[bloomIndex]|parentData[bloomIndex]}return hostView[injectorIndex+PARENT_INJECTOR]=parentLoc,injectorIndex}function setUpBloom(arr,footer){arr.push(0,0,0,0,0,0,0,0,footer)}function getInjectorIndex(tNode,hostView){return-1===tNode.injectorIndex||tNode.parent&&tNode.parent.injectorIndex===tNode.injectorIndex||null==hostView[tNode.injectorIndex+PARENT_INJECTOR]?-1:tNode.injectorIndex}function getParentInjectorLocation(tNode,view){if(tNode.parent&&-1!==tNode.parent.injectorIndex)return tNode.parent.injectorIndex;for(var hostTNode=view[HOST_NODE],viewOffset=1;hostTNode&&-1===hostTNode.injectorIndex;)hostTNode=(view=view[DECLARATION_VIEW])[HOST_NODE],viewOffset++;return hostTNode?hostTNode.injectorIndex|viewOffset<<15:-1}function getParentInjectorView(location,startView){for(var viewOffset=location>>15,parentView=startView;viewOffset>0;)parentView=parentView[DECLARATION_VIEW],viewOffset--;return parentView}function diPublicInInjector(injectorIndex,view,def){!function(injectorIndex,tView,type){if(tView.firstTemplatePass){var id=type[NG_ELEMENT_ID];null==id&&(id=type[NG_ELEMENT_ID]=nextNgElementId++);var bloomBit=id&BLOOM_MASK,mask=1<<bloomBit,b7=128&bloomBit,b6=64&bloomBit,b5=32&bloomBit,tData=tView.data;b7?b6?b5?tData[injectorIndex+7]|=mask:tData[injectorIndex+6]|=mask:b5?tData[injectorIndex+5]|=mask:tData[injectorIndex+4]|=mask:b6?b5?tData[injectorIndex+3]|=mask:tData[injectorIndex+2]|=mask:b5?tData[injectorIndex+1]|=mask:tData[injectorIndex]|=mask}}(injectorIndex,view[TVIEW],def.type)}function diPublic(def){diPublicInInjector(getOrCreateNodeInjectorForNode(getPreviousOrParentTNode(),_getViewData()),_getViewData(),def)}function directiveInject(token,flags){return void 0===flags&&(flags=0),getOrCreateInjectable(getPreviousOrParentTNode(),_getViewData(),token,flags)}function injectAttribute(attrNameToInject){var tNode=getPreviousOrParentTNode();ngDevMode&&assertNodeOfPossibleTypes(tNode,0,3,4),ngDevMode&&assertDefined(tNode,"expecting tNode");var attrs=tNode.attrs;if(attrs)for(var i=0;i<attrs.length;i+=2){var attrName=attrs[i];if(1===attrName)break;if(attrName==attrNameToInject)return attrs[i+1]}}function getOrCreateInjectable(hostTNode,hostView,token,flags){void 0===flags&&(flags=0);var bloomHash=function(token){var tokenId=token[NG_ELEMENT_ID];return"number"==typeof tokenId?tokenId&BLOOM_MASK:tokenId}(token);if("function"==typeof bloomHash)return bloomHash();if(null!=bloomHash){var startInjectorIndex=getInjectorIndex(hostTNode,hostView),injectorIndex=startInjectorIndex,injectorView=hostView,parentLocation=-1;for((4&flags||-1===injectorIndex)&&(shouldNotSearchParent(flags,parentLocation=-1===injectorIndex?getParentInjectorLocation(hostTNode,hostView):injectorView[injectorIndex+PARENT_INJECTOR])?injectorIndex=-1:(injectorIndex=32767&parentLocation,injectorView=getParentInjectorView(parentLocation,injectorView)));-1!==injectorIndex;){for(;-1!==injectorIndex&&!injectorHasToken(bloomHash,injectorIndex,injectorView[TVIEW].data);){if(shouldNotSearchParent(flags,parentLocation=injectorView[injectorIndex+PARENT_INJECTOR])){injectorIndex=-1;break}if(!injectorHasToken(bloomHash,injectorIndex,injectorView)){injectorIndex=-1;break}injectorIndex=32767&parentLocation,injectorView=getParentInjectorView(parentLocation,injectorView)}if(-1===injectorIndex)break;var instance=void 0;if(instance=searchDirectivesOnInjector(injectorIndex,injectorView,token))return instance;if(injectorIndex===startInjectorIndex&&hostView===injectorView&&(instance=searchMatchesQueuedForCreation(token,injectorView[TVIEW])))return instance;injectorIndex=32767&parentLocation,injectorView=getParentInjectorView(parentLocation,injectorView)}}var formerInjector=setCurrentInjector(hostView[INJECTOR$1]);try{return inject(token,flags)}finally{setCurrentInjector(formerInjector)}}function searchMatchesQueuedForCreation(token,hostTView){var matches=hostTView.currentMatches;if(matches)for(var i=0;i<matches.length;i+=2){var def=matches[i];if(def.type===token)return resolveDirective(def,i+1,matches)}return null}function searchDirectivesOnInjector(injectorIndex,injectorView,token){var nodeFlags=injectorView[TVIEW].data[injectorIndex+TNODE].flags,count=4095&nodeFlags;if(0!==count)for(var start=nodeFlags>>15,end=start+count,defs=injectorView[TVIEW].data,i=start;i<end;i++){var directiveDef=defs[i];if(directiveDef.type===token&&directiveDef.diPublic)return injectorView[i]}return null}function injectorHasToken(bloomHash,injectorIndex,injectorView){var mask=1<<bloomHash,b6=64&bloomHash,b5=32&bloomHash;return!!((128&bloomHash?b6?b5?injectorView[injectorIndex+7]:injectorView[injectorIndex+6]:b5?injectorView[injectorIndex+5]:injectorView[injectorIndex+4]:b6?b5?injectorView[injectorIndex+3]:injectorView[injectorIndex+2]:b5?injectorView[injectorIndex+1]:injectorView[injectorIndex])&mask)}function shouldNotSearchParent(flags,parentLocation){return 2&flags||1&flags&&parentLocation>>15>0}var NodeInjector=function(){function NodeInjector(_tNode,_hostView){this._tNode=_tNode,this._hostView=_hostView,this._injectorIndex=getOrCreateNodeInjectorForNode(_tNode,_hostView)}return NodeInjector.prototype.get=function(token){var tNode,view;return tNode=this._tNode,view=this._hostView,previousOrParentTNode=tNode,viewData=view,getOrCreateInjectable(this._tNode,this._hostView,token)},NodeInjector}();function getFactoryOf(type){var typeAny=type,def=getComponentDef(typeAny)||getDirectiveDef(typeAny)||getPipeDef(typeAny)||getInjectableDef(typeAny)||getInjectorDef(typeAny);return def&&void 0!==def.factory?def.factory:null}function getInheritedFactory(type){var factory=getFactoryOf(Object.getPrototypeOf(type.prototype).constructor);return null!==factory?factory:function(t){return new t}}function PublicFeature(definition){definition.diPublic=diPublic}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function noopFactory(){for(var tokens=[],_i=0;_i<arguments.length;_i++)tokens[_i]=arguments[_i]}var R3_ELEMENT_REF_FACTORY__POST_NGCC__=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(ElementRefToken){return createElementRef(ElementRefToken,getPreviousOrParentTNode(),_getViewData())},R3_TEMPLATE_REF_FACTORY__POST_NGCC__=function(TemplateRefToken,ElementRefToken){return createTemplateRef(TemplateRefToken,ElementRefToken,getPreviousOrParentTNode(),_getViewData())},R3_CHANGE_DETECTOR_REF_FACTORY__POST_NGCC__=function(){return createViewRef(getPreviousOrParentTNode(),_getViewData(),null)},R3_VIEW_CONTAINER_REF_FACTORY__POST_NGCC__=function(ViewContainerRefToken,ElementRefToken){return function(ViewContainerRefToken,ElementRefToken,hostTNode,hostView){var lContainer;R3ViewContainerRef||(R3ViewContainerRef=function(_super){function ViewContainerRef_(_lContainer,_hostTNode,_hostView){var _this=_super.call(this)||this;return _this._lContainer=_lContainer,_this._hostTNode=_hostTNode,_this._hostView=_hostView,_this._viewRefs=[],_this}return __extends(ViewContainerRef_,_super),Object.defineProperty(ViewContainerRef_.prototype,"element",{get:function(){return createElementRef(ElementRefToken,this._hostTNode,this._hostView)},enumerable:!0,configurable:!0}),Object.defineProperty(ViewContainerRef_.prototype,"injector",{get:function(){return new NodeInjector(this._hostTNode,this._hostView)},enumerable:!0,configurable:!0}),Object.defineProperty(ViewContainerRef_.prototype,"parentInjector",{get:function(){var parentLocation=getParentInjectorLocation(this._hostTNode,this._hostView),parentView=getParentInjectorView(parentLocation,this._hostView),parentIndex=32767&parentLocation,parentTNode=parentView[TVIEW].data[parentIndex];return-1===parentLocation?new NullInjector:new NodeInjector(parentTNode,parentView)},enumerable:!0,configurable:!0}),ViewContainerRef_.prototype.clear=function(){for(;this._lContainer[VIEWS].length;)this.remove(0)},ViewContainerRef_.prototype.get=function(index){return this._viewRefs[index]||null},Object.defineProperty(ViewContainerRef_.prototype,"length",{get:function(){return this._lContainer[VIEWS].length},enumerable:!0,configurable:!0}),ViewContainerRef_.prototype.createEmbeddedView=function(templateRef,context,index){var adjustedIdx=this._adjustIndex(index),viewRef=templateRef.createEmbeddedView(context||{},this._lContainer,this._hostTNode,this._hostView,adjustedIdx);return viewRef.attachToViewContainerRef(this),this._viewRefs.splice(adjustedIdx,0,viewRef),viewRef},ViewContainerRef_.prototype.createComponent=function(componentFactory,index,injector,projectableNodes,ngModuleRef){var contextInjector=injector||this.parentInjector;!ngModuleRef&&contextInjector&&(ngModuleRef=contextInjector.get(NgModuleRef,null));var componentRef=componentFactory.create(contextInjector,projectableNodes,void 0,ngModuleRef);return this.insert(componentRef.hostView,index),componentRef},ViewContainerRef_.prototype.insert=function(viewRef,index){if(viewRef.destroyed)throw new Error("Cannot insert a destroyed View in a ViewContainer!");var lView=viewRef._view,adjustedIdx=this._adjustIndex(index);insertView(lView,this._lContainer,this._hostView,adjustedIdx,this._hostTNode.index);var beforeNode=getBeforeNodeForView(adjustedIdx,this._lContainer[VIEWS],this._lContainer[NATIVE]);return addRemoveViewFromContainer(lView,!0,beforeNode),viewRef.attachToViewContainerRef(this),this._viewRefs.splice(adjustedIdx,0,viewRef),viewRef},ViewContainerRef_.prototype.move=function(viewRef,newIndex){var index=this.indexOf(viewRef);return this.detach(index),this.insert(viewRef,this._adjustIndex(newIndex)),viewRef},ViewContainerRef_.prototype.indexOf=function(viewRef){return this._viewRefs.indexOf(viewRef)},ViewContainerRef_.prototype.remove=function(index){var adjustedIdx=this._adjustIndex(index,-1);removeView(this._lContainer,this._hostTNode,adjustedIdx),this._viewRefs.splice(adjustedIdx,1)},ViewContainerRef_.prototype.detach=function(index){var adjustedIdx=this._adjustIndex(index,-1);return detachView(this._lContainer,adjustedIdx,!!this._hostTNode.detached),this._viewRefs.splice(adjustedIdx,1)[0]||null},ViewContainerRef_.prototype._adjustIndex=function(index,shift){return void 0===shift&&(shift=0),null==index?this._lContainer[VIEWS].length+shift:(ngDevMode&&(index<=-1&&throwError("index must be positive"),assertLessThan(index,this._lContainer[VIEWS].length+1+shift,"index")),index)},ViewContainerRef_}(ViewContainerRefToken)),ngDevMode&&assertNodeOfPossibleTypes(hostTNode,0,3,4);var slotValue=hostView[hostTNode.index];if(isLContainer(slotValue))(lContainer=slotValue)[ACTIVE_INDEX]=-1;else{var comment=hostView[RENDERER].createComment(ngDevMode?"container":"");ngDevMode&&ngDevMode.rendererCreateComment++,hostView[hostTNode.index]=lContainer=createLContainer(slotValue,hostTNode,hostView,comment,!0),appendChild(comment,hostTNode,hostView),addToViewTree(hostView,hostTNode.index,lContainer)}return new R3ViewContainerRef(lContainer,hostTNode,hostView)}(ViewContainerRefToken,ElementRefToken,getPreviousOrParentTNode(),_getViewData())},R3_RENDERER2_FACTORY__POST_NGCC__=function(){return function(view){var renderer=view[RENDERER];if(isProceduralRenderer(renderer))return renderer;throw new Error("Cannot inject Renderer2 when the application uses Renderer3!")}(_getViewData())}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isUseClassProvider(meta){return void 0!==meta.useClass}var USE_VALUE$2=getClosureSafeProperty({provide:String,useValue:getClosureSafeProperty});function isUseValueProvider(meta){return USE_VALUE$2 in meta}function isUseFactoryProvider(meta){return void 0!==meta.useFactory}function isUseExistingProvider(meta){return void 0!==meta.useExisting}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var R3_COMPILE_COMPONENT$1=function(type,metadata){var ngComponentDef=null;!function(metadata){componentNeedsResolution(metadata)&&componentResourceResolutionQueue.add(metadata)}(metadata),Object.defineProperty(type,NG_COMPONENT_DEF,{get:function(){if(null===ngComponentDef){if(componentNeedsResolution(metadata)){var error=["Component '"+stringify(type)+"' is not resolved:"];throw metadata.templateUrl&&error.push(" - templateUrl: "+stringify(metadata.templateUrl)),metadata.styleUrls&&metadata.styleUrls.length&&error.push(" - styleUrls: "+JSON.stringify(metadata.styleUrls)),error.push("Did you run and wait for 'resolveComponentResources()'?"),new Error(error.join("\n"))}var constantPool=new _angular_compiler.ConstantPool,template=_angular_compiler.parseTemplate(metadata.template,"ng://"+stringify(type)+"/template.html",{preserveWhitespaces:metadata.preserveWhitespaces||!1},"");if(void 0!==template.errors){var errors=template.errors.map(function(err){return err.toString()}).join(", ");throw new Error("Errors during JIT compilation of template for "+stringify(type)+": "+errors)}var animations=null!==metadata.animations?new _angular_compiler.WrappedNodeExpr(metadata.animations):null,res=_angular_compiler.compileComponentFromMetadata(__assign({},directiveMetadata(type,metadata),{template:template,directives:new Map,pipes:new Map,viewQueries:[],wrapDirectivesInClosure:!1,styles:metadata.styles||[],encapsulation:metadata.encapsulation||ViewEncapsulation.Emulated,animations:animations}),constantPool,_angular_compiler.makeBindingParser()),preStatements=constantPool.statements.concat(res.statements);if(ngComponentDef=_angular_compiler.jitExpression(res.expression,angularCoreEnv,"ng://"+type.name+"/ngComponentDef.js",preStatements),void 0!==type.ngSelectorScope){var scopes=transitiveScopesFor(type.ngSelectorScope);patchComponentDefWithScope(ngComponentDef,scopes)}}return ngComponentDef},configurable:!!ngDevMode})},R3_COMPILE_DIRECTIVE$1=function(type,directive){var ngDirectiveDef=null;Object.defineProperty(type,NG_DIRECTIVE_DEF,{get:function(){if(null===ngDirectiveDef){var constantPool=new _angular_compiler.ConstantPool,sourceMapUrl="ng://"+(type&&type.name)+"/ngDirectiveDef.js",res=_angular_compiler.compileDirectiveFromMetadata(directiveMetadata(type,directive),constantPool,_angular_compiler.makeBindingParser()),preStatements=constantPool.statements.concat(res.statements);ngDirectiveDef=_angular_compiler.jitExpression(res.expression,angularCoreEnv,sourceMapUrl,preStatements)}return ngDirectiveDef},configurable:!!ngDevMode})},R3_COMPILE_PIPE$1=function(type,meta){var ngPipeDef=null;Object.defineProperty(type,NG_PIPE_DEF,{get:function(){if(null===ngPipeDef){var sourceMapUrl="ng://"+stringify$1(type)+"/ngPipeDef.js",name_1=type.name,res=_angular_compiler.compilePipeFromMetadata({name:name_1,type:new _angular_compiler.WrappedNodeExpr(type),deps:reflectDependencies(type),pipeName:meta.name,pure:void 0===meta.pure||meta.pure});ngPipeDef=_angular_compiler.jitExpression(res.expression,angularCoreEnv,sourceMapUrl,res.statements)}return ngPipeDef},configurable:!!ngDevMode})},R3_COMPILE_NGMODULE_DEFS$1=compileNgModuleDefs,R3_PATCH_COMPONENT_DEF_WTIH_SCOPE$1=patchComponentDefWithScope;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
